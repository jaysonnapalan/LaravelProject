...
<!-- Favicon -->
<link rel="icon" type="image/x-icon" href="../public/assets/img/favicon/slsu.png" />
  ...
  <div class="row">
    <div class="col-lg-8 mb-4 order-0">
        ...
        <div class="d-flex align-items-end row">
          <div class="col-sm-7">
            <div class="card-body">
              ...
              <a href="{{ route('sports.index') }}" class="btn btn-sm btn-outline-primary">VIEW ALL SPORTS</a>
            </div>
          </div>
      ...
      <div class="slider-container mt-4">
        <div class="slider">
          <img src="../assets/img/backgrounds/slsu.png" alt="Slide 0">
        ...
        <div class="col-lg-6 col-md-12 col-6 mb-4">
          <div class="card">
            <div class="card-body">
              ...
              <a href="{{ route('sports.index') }}" class="fw-semibold d-block mb-1 text-decoration-none text-primary">
